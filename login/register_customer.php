    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                <h2><i class="fas fa-user-plus"></i> Register as a Customer</h2>
                <p class="mb-0">Create your Eventify customer account</p>
            </div>
            ...
            <div class="login-footer">
                ...
                <p class="mb-0">Are you a business? <a href="register_business.php">Register here</a>.</p>
            </div>
        </div>
    </div>
