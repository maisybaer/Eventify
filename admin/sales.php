  ...
  <header>
    ...
    <div class="container header-container">
        <div class="text-center mb-5 fade-in">
            ...
            <h1 class="mb-2"><i class="fas fa-chart-line"></i> Sales</h1>
            <p class="text-muted">View the ticket sales for your events</p>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="orderItemsContainer">
                            <div class="text-center py-4" id="orderItemsLoading">Loading items...</div>
                        </div>
                    </div>
