...
<body>
    <header class="menu-tray">
        ...
        <?php else: ?>
            <a href="../login/login.php" class="btn btn-sm btn-outline-secondary"><i class="fas fa-sign-in-alt"></i> Login</a>
            <a href="../login/register_customer.php" class="btn btn-sm btn-primary"><i class="fas fa-user-plus"></i> Sign Up</a>
        <?php endif; ?>
    </header>
